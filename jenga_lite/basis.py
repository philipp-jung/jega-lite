...
class Task(ABC):
    ...
    def _get_task_type_of_data(self) -> int | None:
    ...
    def fit_baseline_model(self, train_data: pd.DataFrame | None = None, train_labels: pd.Series | None = None) -> BaseEstimator:
...
class TabularCorruption(DataCorruption):
    def __init__(self, column, fraction, sampling="CAR") -> None:
